...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'nijisanjitower_ver1.01.data';
    var REMOTE_PACKAGE_BASE = 'nijisanjitower_ver1.01.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 23935710;
      var PACKAGE_UUID = '27094733-15bb-4bdb-989e-a5f4c777b485';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 21094227, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(21094227, 21095196, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(21095196, 21099053, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(21099053, 23033113, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(23033113, 23908085, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(23908085, 23935710, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_nijisanjitower_ver1.01.data');

    };
    Module['addRunDependency']('datafile_nijisanjitower_ver1.01.data');
