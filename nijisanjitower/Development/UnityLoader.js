...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'nijisanjitower_ver1.0.data';
    var REMOTE_PACKAGE_BASE = 'nijisanjitower_ver1.0.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 23939770;
      var PACKAGE_UUID = '5ff3594c-fd70-43c1-a4af-0464cc4941e9';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 21094738, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(21094738, 21095707, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(21095707, 21099801, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(21099801, 23037173, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(23037173, 23912145, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(23912145, 23939770, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_nijisanjitower_ver1.0.data');

    };
    Module['addRunDependency']('datafile_nijisanjitower_ver1.0.data');
