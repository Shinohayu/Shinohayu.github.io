...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'nijisanjitower_ver1.02.data';
    var REMOTE_PACKAGE_BASE = 'nijisanjitower_ver1.02.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 23935438;
      var PACKAGE_UUID = '9d42e3ee-4bce-4beb-be3e-150063352086';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 21093955, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(21093955, 21094924, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(21094924, 21098781, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(21098781, 23032841, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(23032841, 23907813, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(23907813, 23935438, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_nijisanjitower_ver1.02.data');

    };
    Module['addRunDependency']('datafile_nijisanjitower_ver1.02.data');
